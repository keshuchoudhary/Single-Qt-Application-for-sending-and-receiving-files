...
QT_MOC_LITERAL(1, 12, 10), // "receiveUdp"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5), // "getIp"
QT_MOC_LITERAL(4, 30, 7) // "getPort"

    },
    "UdpReceiver\0receiveUdp\0\0getIp\0getPort"
};
...
void UdpReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->receiveUdp(); break;
        case 1: { QString _r = _t->getIp();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 2: { quint16 _r = _t->getPort();
